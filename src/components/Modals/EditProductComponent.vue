      ...
      <div class="modal-content">
        ...
        <div class="row">
          <div class="input-field col s12 m6">
            ...
            <label for="ebatch_id" data-error="Select a batch"
              >Product Batch</label
            >
          </div>
          <div class="input-field col s12 m6">
...
export default {
  ...
  methods: {
    ...
    updateProduct: function (event) {
      ...
      this.loading = true;
      axios.post(url + "product/" + this.product.id, productData).then(
        (response) => {
          ...
          if (data.status === "success") {
            ...
            console.log(data);
            this.errorMessage =
              "Product can not be updated at the moment due to system error!!";
