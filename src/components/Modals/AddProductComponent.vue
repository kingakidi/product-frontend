      ...
      <div class="modal-content">
        ...
        <div class="row">
          <div class="input-field col s12 m6">
            ...
            <label for="batch_id" data-error="Select a batch"
              >Product Batch</label
            >
          </div>
          <div class="input-field col s12 m6">
        ...
        .then(
          (response) => {
            ...
            if (data.status === "success") {
              if (data.message.toLowerCase() === "product added") {
              ...
              console.log(data);
              this.errorMessage =
                "Product can not be added at the moment due to system error!!";
