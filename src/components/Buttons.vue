      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col m1 s6 lg1">
            <button
              class="waves-effect waves-light btn dropdown-trigger"
            ...
            <ul id="dropdown1" class="dropdown-content">
              <li>
                <a href="#" class="modal-trigger" data-target="account-modal"
                  >Change Password</a
                >
              </li>
...
<script>
import AddProductComponent from "./Modals/AddProductComponent";
import AddBatchComponent from "./Modals/AddBatchComponent";
